    ...
    >
      <div className="w-full max-w-sm rounded-lg border border-border bg-card shadow-lg">
        <div className="flex items-center justify-between border-b border-border px-5 py-4">
          <h2 className="text-sm font-semibold text-foreground">Delete job</h2>
        ...
        <div className="p-5">
          <p className="text-sm text-foreground">
            Delete <span className="font-semibold">{jobName(job)}</span>?
          </p>
          <p className="mt-1 text-xs text-muted-foreground">
            This is permanent. Downloaded files are not affected.
          </p>
