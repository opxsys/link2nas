...
export default function ProviderDeleteModal({ config, onClose, onDeleted }: Props) {
  ...
  return (
    <div
      ...
      role="dialog" aria-modal="true" aria-label="Delete provider"
      onMouseDown={(e) => { if (e.target === e.currentTarget) onClose() }}
    >
      <div className="w-full max-w-sm rounded-lg border border-border bg-card shadow-lg">
        <div className="flex items-center justify-between border-b border-border px-5 py-4">
          <h2 className="text-sm font-semibold text-foreground">Delete provider</h2>
        ...
        <div className="p-5">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            This is permanent and cannot be undone. Existing jobs that used this provider are not affected.
          </p>
