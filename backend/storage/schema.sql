...
CREATE TABLE IF NOT EXISTS users (
    ...
    receive_application_emails INTEGER NOT NULL DEFAULT 0,

    public_slug TEXT UNIQUE DEFAULT NULL,
    can_use_local_space INTEGER NOT NULL DEFAULT 0,
    ui_theme TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS jobs (
    ...
    send_to_destination INTEGER NOT NULL DEFAULT 0,
    sent_to_destination INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS user_integration_settings (
    ...
    prowlarr_enabled INTEGER NOT NULL DEFAULT 0,
    prowlarr_url TEXT,
...
CREATE TABLE IF NOT EXISTS prowlarr_configs (
    ...
    user_id           TEXT,                   -- NULL for scope='global'
    enabled           INTEGER NOT NULL DEFAULT 0,
    base_url          TEXT,
    encrypted_api_key TEXT,
    label             TEXT,
...
ON prowlarr_configs (user_id) WHERE scope = 'user';
